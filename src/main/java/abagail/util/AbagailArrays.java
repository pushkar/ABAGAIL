...
public class AbagailArrays {
    ...
    private AbagailArrays() { }

    /**
     * Print out an array.
     *
     * @param array  the array to print
     * @param digits the number of digits after the decimal place to use
    ...
    /**
     * Partition an array in place according to the
     ...
     * @return the index of the value or the index of the closest value
     * greater than it
     */
